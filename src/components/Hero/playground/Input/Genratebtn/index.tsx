...
const GenerateButton = () => {
  ...
  return (
    <button
      ...
      className="bg-[#9e67fa] box-border content-stretch flex gap-[10px] h-[56px] items-center justify-center overflow-clip px-[24px] py-[10px] relative rounded-[99px] shrink-0 w-full"
    >
