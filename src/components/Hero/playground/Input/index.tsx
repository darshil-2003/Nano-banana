...
const Input = () => {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] box-border content-stretch flex flex-col gap-[12px] sm:gap-[16px] items-start justify-start p-[12px] sm:p-[16px] relative rounded-[24px] sm:rounded-[32px] shrink-0 w-full max-w-[530px]">
      <div
        aria-hidden="true"
