...
const ImageUpload = () => {
  ...
  return (
    <div
      className={`bg-[rgba(255,255,255,0.02)] box-border content-stretch flex flex-col h-[200px] items-center justify-between p-[16px] relative rounded-[24px] shrink-0 w-full  ${
    ...
    >
      <div
        aria-hidden="true"
        className="absolute border-2 border-[rgba(235,240,255,0.1)] border-dashed inset-0 pointer-events-none rounded-[24px]"
      />
      <div className="content-stretch flex flex-col gap-[4px] items-center justify-start relative shrink-0">
