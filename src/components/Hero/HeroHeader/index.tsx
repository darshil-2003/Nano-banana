...
const HeroHeader = () => {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-start leading-[0] not-italic relative shrink-0 text-center w-full max-w-[1070px] mx-auto mb-8 sm:mb-12 md:mb-16 lg:mb-[60px]">
      <div
      ...
      <div className="font-['Mona_Sans:Regular',_sans-serif] relative shrink-0 text-[18px] text-[rgba(255,255,255,0.5)] tracking-[0.36px] w-full max-w-[836px]">
